...
/* WEBPACK VAR INJECTION */(function($) {$(document).ready(function () {
  ...
  $('.contenteditable').each(function () {
    var ce_text = $(this).data('reset'); // alert(ce_text);
  ...
  $('.btn-invert').on('click', function () {
    $('html').toggleClass('invert'); // $(this).css('outline', 'solid 10px green');
  ...
  $(document).on('mousemove', function (event) {
    ...
    yPercent = event.pageY / $('section.cover').height() * 100; // remove decimals

    xPercentFixed = xPercent.toFixed();
    yPercentFixed = yPercent.toFixed(); // translate viewport position to font axes
  ...
  $(window).on('popstate', function () {
    ...
    $('.examples-link-' + currentState).click(); // if(currentState == "1") {
...
(function (e, t) {
  ...
  var n = e.History = e.History || {},
      r = __webpack_provided_window_dot_jQuery;
